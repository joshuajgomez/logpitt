...
val dummyLogList = listOf(
    ...
    LogData(priority = Priority.VERBOSE, log = "11-05 20:22:08.354  7152  7961 V cevx    : Is http uri, downloading (uri: https://c.tenor.com/yIGMxqme4k4AAAAk/tenor.gif)"),
    LogData(priority = Priority.ERROR, log = "10-21 13:53:57.036     0     0 E         : fail to initialize ptp_kvm"),
    LogData(priority = Priority.INFO, log = "10-21 13:53:55.999     0     0 I         : Linux version 6.1.23-android14-4-00257-g7e35917775b8-ab9964412 (build-user@build-host) (Android (9796371, based on r487747) clang version 17.0.0 (https://android.googlesource.com/toolchain/llvm-project d9f89f4d16663d5012e5c09495f3b30ece3d2362), LLD 17.0.0) #1 SMP PREEMPT Mon Apr 17 20:50:58 UTC 2023"),
)